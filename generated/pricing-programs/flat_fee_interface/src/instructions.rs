    ...
    pub fn deserialize(buf: &[u8]) -> std::io::Result<Self> {
        ...
        match maybe_discm {
            PRICE_EXACT_IN_IX_DISCM => {
                Ok(Self::PriceExactIn(PriceExactInIxArgs::deserialize(&mut reader)?))
            }
            PRICE_EXACT_OUT_IX_DISCM => {
                Ok(Self::PriceExactOut(PriceExactOutIxArgs::deserialize(&mut reader)?))
            }
            PRICE_LP_TOKENS_TO_MINT_IX_DISCM => {
                Ok(
                    Self::PriceLpTokensToMint(
                        PriceLpTokensToMintIxArgs::deserialize(&mut reader)?,
                    ),
                )
            }
            PRICE_LP_TOKENS_TO_REDEEM_IX_DISCM => {
                Ok(
                    Self::PriceLpTokensToRedeem(
                        PriceLpTokensToRedeemIxArgs::deserialize(&mut reader)?,
                    ),
                )
            }
            SET_LP_WITHDRAWAL_FEE_IX_DISCM => {
                Ok(
                    Self::SetLpWithdrawalFee(
                        SetLpWithdrawalFeeIxArgs::deserialize(&mut reader)?,
                    ),
                )
            }
            SET_LST_FEE_IX_DISCM => {
                Ok(Self::SetLstFee(SetLstFeeIxArgs::deserialize(&mut reader)?))
            }
...
impl From<PriceLpTokensToMintKeys>
for [AccountMeta; PRICE_LP_TOKENS_TO_MINT_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; PRICE_LP_TOKENS_TO_MINT_IX_ACCOUNTS_LEN]>
for PriceLpTokensToMintKeys {
    fn from(pubkeys: [Pubkey; PRICE_LP_TOKENS_TO_MINT_IX_ACCOUNTS_LEN]) -> Self {
        Self { input_lst_mint: pubkeys[0] }
    }
}
...
for PriceLpTokensToMintAccounts<'me, 'info> {
    fn from(
        arr: &'me [AccountInfo<'info>; PRICE_LP_TOKENS_TO_MINT_IX_ACCOUNTS_LEN],
    ) -> Self {
        Self { input_lst_mint: &arr[0] }
    }
}
...
pub fn price_lp_tokens_to_mint_invoke_signed(
    ...
    price_lp_tokens_to_mint_invoke_signed_with_program_id(
        crate::ID,
        accounts,
        args,
        seeds,
...
impl From<PriceLpTokensToRedeemKeys>
for [AccountMeta; PRICE_LP_TOKENS_TO_REDEEM_IX_ACCOUNTS_LEN] {
...
impl From<[Pubkey; PRICE_LP_TOKENS_TO_REDEEM_IX_ACCOUNTS_LEN]>
for PriceLpTokensToRedeemKeys {
...
impl<
    'me,
    'info,
> From<&'me [AccountInfo<'info>; PRICE_LP_TOKENS_TO_REDEEM_IX_ACCOUNTS_LEN]>
for PriceLpTokensToRedeemAccounts<'me, 'info> {
    fn from(
        arr: &'me [AccountInfo<'info>; PRICE_LP_TOKENS_TO_REDEEM_IX_ACCOUNTS_LEN],
    ) -> Self {
        Self {
...
pub fn price_lp_tokens_to_redeem_invoke_signed(
    ...
    price_lp_tokens_to_redeem_invoke_signed_with_program_id(
        crate::ID,
        accounts,
        args,
        seeds,
...
impl From<SetLpWithdrawalFeeKeys>
for [AccountMeta; SET_LP_WITHDRAWAL_FEE_IX_ACCOUNTS_LEN] {
...
for SetLpWithdrawalFeeAccounts<'me, 'info> {
    fn from(
        arr: &'me [AccountInfo<'info>; SET_LP_WITHDRAWAL_FEE_IX_ACCOUNTS_LEN],
    ) -> Self {
        Self {
            manager: &arr[0],
            state: &arr[1],
...
for [AccountInfo<'info>; SET_LST_FEE_IX_ACCOUNTS_LEN] {
    fn from(accounts: SetLstFeeAccounts<'_, 'info>) -> Self {
        [accounts.manager.clone(), accounts.fee_acc.clone(), accounts.state.clone()]
    }
}
...
for [AccountInfo<'info>; INITIALIZE_IX_ACCOUNTS_LEN] {
    fn from(accounts: InitializeAccounts<'_, 'info>) -> Self {
        [accounts.payer.clone(), accounts.state.clone(), accounts.system_program.clone()]
    }
}
